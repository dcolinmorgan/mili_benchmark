...
do
  ...
  cat data/MotifPipeline/remap/"$cell"_spRE2020.txt >  $bench/overlap_tmpBB_$cell"_"$buffer$out_fmt #$bench/$cell"_"$gene
  sed -i.bak 's/\t\t/\t/' $bench/overlap_tmpBB_$cell"_"$buffer$out_fmt
...
# do
  ...
  do
    ...
    eval "~/../rekrg/Tools/bedtools2/bin/bedtools intersect -wao -a $bench/overlap_tmpC_"$cell"_"$buffer".txt -b $bench/overlap_tmpBB_"$cell"_"$buffer".txt " > $bench/overlap_tmpCC_$cell"_"$buffer$out_fmt #bench/overlap_tmpE_$cell"_"$buffer$out_fmt
    ...
    rm $bench/overlap_tmpCC_$cell"_"$buffer$out_fmt $bench/overlap_tmpC_$cell"_"$buffer$out_fmt $bench/overlap_tmpD_$cell"_"$buffer$out_fmt

done
rm $bench/overlap_tmpBB_$cell"_"$buffer$out_fmt
done
