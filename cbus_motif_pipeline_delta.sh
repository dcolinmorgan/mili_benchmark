...
do
  ...
  eval "~/../rekrg/Tools/bedtools2/bin/bedtools intersect -wao -a data/MotifPipeline/ENCODE/wgbsin/"$cell"both.txt -b data/MotifPipeline/remap/"$cell"_spRE2020.txt " >  $bench/overlap_tmpBB_$cell"_"$buffer$out_fmt #$bench/$cell"_"$gene
